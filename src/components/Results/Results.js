...
export function Results({ articles, onSaveArticle, onDeleteArticle }) {
    ...
    <div className="results">
      <div className="results__container">
        ...
        <div className="results__news">
          <NewsCardList cardList={articles.slice(0, countArticles)} onSaveArticle={onSaveArticle} onDeleteArticle={onDeleteArticle} />
        </div>
        {
